...
var uri_mongoose = "mongodb+srv://admin:Luc@2001@cluster0.clu27.mongodb.net/tinder?retryWrites=true&w=majority";
...
router.get('/search', function (req, res, next) {
    ...
    userModel.find({name: req.query.search}, function (error, userList) {
        ...
        } else {            res.render('user_list', {layout: 'main_home', message: error.message});
        }
    });
});
